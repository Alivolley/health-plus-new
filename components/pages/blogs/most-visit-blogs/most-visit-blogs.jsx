...
function MostVisitBlogs({ mostVisitPsychoBlogsData, randomBlogsData2 }) {
   const firstSwiperRef = useRef(null);
   const secondSwiperRef = useRef(null);

   return (
      <div className="mt-30 grid grid-cols-3 gap-x-30">
         <div className="col-span-2">
            <div>
               <div className="mb-30 flex items-center justify-between border-b-2 border-solid border-primaryBlue pb-5">
                  <p className="font-kalamehSemiBold600 text-xl text-textColor1">پر بازدید های روانشناسی</p>
            ...
            <Link href="/filter-medical-advice" className="mt-30 block h-[321px] w-full">
               <Image src={blogBanner} alt="banner" className="size-full" />
            </Link>
         </div>
         <div className="col-span-1 rounded-20 border border-solid border-textColor1/25 p-5 pt-30">
            <div>
               <div className="mb-30 flex items-center justify-between border-b-2 border-solid border-primaryBlue pb-5">
